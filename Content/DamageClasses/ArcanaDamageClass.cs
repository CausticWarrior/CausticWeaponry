...
namespace CausticWeaponry.Content.DamageClasses
{
	public class ArcanaDamageClass : DamageClass
	{
		...
		public override void SetDefaultStats(Player player)
		{
			...
			player.GetCritChance<ArcanaDamageClass>() += 4;
			player.GetArmorPenetration<ArcanaDamageClass>() += 10;
